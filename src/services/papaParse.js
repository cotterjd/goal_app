...
!(function(a, b) {
  ...
  function a(a, b) {
    ...
    if (
      (r(c) && ((b.dynamicTypingFunction = c), (c = {})),
      (b.dynamicTyping = c),
    ...
    return (
      "string" == typeof a
        ...
        : a.readable === !0 && r(a.read) && r(a.on)
          ? (i = new g(b))
          : ((t.File && a instanceof File) || a instanceof Object) &&
            (i = new e(b)),
      i.stream(a)
    );
  }
    ...
    function c() {
      "object" == typeof b &&
        ("string" == typeof b.delimiter &&
          ...
          (j = b.delimiter),
        ("boolean" == typeof b.quotes || b.quotes instanceof Array) &&
          (h = b.quotes),
    ...
    (this._handle = null),
      ...
      (this.parseChunk = function(a) {
        ...
        if (!this._handle.paused() && !this._handle.aborted()) {
          var e = d.meta.cursor;
          this._finished ||
            ((this._partialLine = c.substring(e - this._baseIndex)),
            (this._baseIndex = e)),
          ...
          if (v)
            t.postMessage({ results: d, workerId: z.WORKER_ID, finished: f });
      ...
      (this._sendError = function(a) {
        r(this._config.error)
          ...
          : v &&
            this._config.error &&
            t.postMessage({ workerId: z.WORKER_ID, error: a, finished: !1 });
      });
  }
  function d(a) {
    function b(a) {
      ...
      (this._readChunk = function() {
        ...
        if (
          ...
          this._config.withCredentials &&
            (d.withCredentials = this._config.withCredentials),
          u ||
            ((d.onload = q(this._chunkLoaded, this)),
      ...
      (this._input = a),
        ...
        e
          ? ((b = new FileReader()),
            ...
            (b.onerror = q(this._chunkError, this)))
  ...
  function h(a) {
    ...
    function e(b) {
      return (
        a.dynamicTypingFunction &&
          void 0 === a.dynamicTyping[b] &&
          (a.dynamicTyping[b] = a.dynamicTypingFunction(b)),
    ...
    function h(b, c, d) {
      for (
        var e, f, g, h = [",", "\t", "|", ";", z.RECORD_SEP, z.UNIT_SEP], j = 0;
        j < h.length;
        j++
      ) {
        var k = h[j],
        ...
        g = void 0;
        for (
          var o = new i({ delimiter: k, newline: c, preview: 10 }).parse(b),
            p = 0;
          p < o.data.length;
          p++
        )
    ...
    (this.parse = function(c, d, e) {
      if ((a.newline || (a.newline = j(c)), (o = !1), a.delimiter))
        r(a.delimiter) &&
          ((a.delimiter = a.delimiter(c)), (x.meta.delimiter = a.delimiter));
      else {
        var f = h(c, a.newline, a.skipEmptyLines);
        f.successful
          ? (a.delimiter = f.bestDelimiter)
          : ((o = !0), (a.delimiter = z.DefaultDelimiter)),
  ...
  function i(a) {
    ...
    var b = a.delimiter,
      ...
      h = a.quoteChar || '"';
    if (
      (("string" != typeof b || z.BAD_DELIMITERS.indexOf(b) > -1) && (b = ","),
      d === b)
    )
      throw "Comment character same as delimiter";
    d === !0
      ? (d = "#")
      : ("string" != typeof d || z.BAD_DELIMITERS.indexOf(d) > -1) && (d = !1),
      "\n" != c && "\r" != c && "\r\n" != c && (c = "\n");
    var i = 0,
      j = !1;
    (this.parse = function(a, k, l) {
      ...
      function n(b) {
        return l
          ? p()
          : ("undefined" == typeof b && (b = a.substr(i)),
            z.push(b),
            (i = s),
            m(z),
            w && q(),
      ...
      for (
        ...
        if (a[i] !== h)
          if (d && 0 === z.length && a.substr(i, v) === d) {
            ...
            z.push(a.substring(i, D)), (i = D + t), (D = a.indexOf(b, i));
          else {
            if (E === -1) break;
            if ((z.push(a.substring(i, E)), o(E + u), w && (q(), j)))
              return p();
  ...
  function l(a) {
    ...
    if (b.error) c.userError(b.error, b.file);
      ...
      var e = function() {
          (d = !0),
            m(b.workerId, { data: [], errors: [], meta: { aborted: !0 } });
        },
      ...
      if (r(c.userStep)) {
        ...
        r(c.userChunk) && (c.userChunk(b.results, f, b.file), delete b.results);
    }
  ...
  function o(a) {
    var b = a.data;
    if (
      ("undefined" == typeof z.WORKER_ID && b && (z.WORKER_ID = b.workerId),
        ...
        if (r(a.before)) {
          ...
          if ("object" == typeof e) {
            ...
            "object" == typeof e.config &&
              (b.instanceConfig = A.extend(b.instanceConfig, e.config));
